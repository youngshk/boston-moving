...
- **유틸:** n/p
- **거리/교통:** Alewife에서 ~0.6–1마일(Rt-2 건너), 도보 ~15–20분. 단지 셔틀 운영.
- **🚆 출퇴근(버스·도보·소음):** **무료 평일 피크 셔틀**(Alewife TMA, Discovery Park 공동 운영, AM/PM·주말 미운행, Alewife + 요청 시 Belmont Center 정차, 앱 실시간 추적). ⚠️ 야간 도보는 "가로등 없음" 부정평 → 셔틀 의존도 높음. 단지에 직접 들어오는 MBTA 버스는 없고 Alewife 버스(62·67·76·350)와 셔틀로 연계. ⚠️ 소음: Rt-2 인접 + **건물 HVAC·엘리베이터 소음 불만 반복**(자가측정 90dBA 주장·미검증), 금속빔 구조라 방음 약하다는 평.
- **무브인:** 1BR 다수 즉시 가능(Norbert 10세대). 단 유닛별 날짜·층수는 공식 비공개.
- **거주자 평가:** Google **4.0/5 (130 리뷰, 라이브)** vs **ApartmentRatings 2.9/5 (5건)** — ⚠️ 출처 간 격차 큼.
...
- **🚆 출퇴근(버스·도보·소음):** **Porter역(Red Line + Fitchburg 통근열차) 도보 ~10분**, 보행친화 동네라 셔틀 불필요. 버스: Porter **77·83·96**. 소음: Porter 철로는 지하 오픈컷이라 영향 제한적, **세대 간 얇은 벽** 불만이 주(도로/철도 소음보다).
- **거주자 평가:** Google **4.4/5 (118 리뷰, 라이브)** — Tier 4 중 가장 탄탄한 Google 평점, 최근 긍정 추세. (Equity 자체 4.2/5·1,756건)
