...
!!! warning "데이터 기준 / 주의"
    - **조사 기준일: 2026-06-06.** 렌탈 가격과 프로모션은 거의 매주 바뀝니다. 아래 숫자는 "조사 시점의 최신 리스팅" 기준이며, **계약 전 반드시 리싱 오피스에 전화로 재확인**하세요.
    - 가격은 대부분 base rent 기준입니다. 일부 단지(Urbane 등)는 필수 부대비용을 포함한 "total monthly price"로 표기합니다.
    - 다수 공식 사이트가 Cloudflare/JS 위젯 뒤에 있어, 일부 항목(특히 **주차비, 유닛별 층수**)은 공식 사이트에 미공개("not published")이거나 aggregator 기준입니다. 출처를 각 항목에 표기했습니다.
...
| **가장 저렴한 스튜디오** | Hanover (~$2,250부터), Tempo/Atmark (~$2,600), Vox·605·Park77 ($2,800대) |
| **가장 저렴한 1BR** | Walden Park·Tempo (~$2,670~2,980), Hanover (~$2,810), Atmark (~$2,795) |
...
- **새 건물 + 보너스** → **Urbane**(2주 무료, 미확인), **Luxe**(1개월 무료+보증금 $99, 미확인). 둘 다 공식 배너 직접 확인은 못 해 전화 확인 권장.
- **가격 최우선** → **Hanover**(스튜디오 ~$2,250부터, 주마다 도는 프로모션) 또는 Tier 2의 **Tempo / Atmark**.
- **확실한 1개월 무료를 지금 받고 싶다** → **The Royal Belmont**(6/21 입주 조건) 또는 **The Laurent**($1,000 off, 24시간 내 신청). 단 Royal Belmont는 East Belmont라 셔틀 의존.
