...
(function () {
  function initAlewifeMap() {
    ...
    var places = [
      ...
      {n:'Hanover Alewife', lat:42.39361, lng:-71.14479, t:1, d:'스튜디오 가용없음(공식) · 1BR ~$3,092(Zumper) · 최대 4주+1주(공식) · 평점 4.8'},
      {n:'Windsor at Cambridge Park', lat:42.39450, lng:-71.14772, t:1, d:'스튜디오 가용없음 · 1BR $3,053~(공식) · 2014년 398세대'},
